...
type MarketAPI interface {
	...
	OpenDeal(ctx context.Context, key *ecdsa.PrivateKey, askID, bigID *big.Int) DealOrError
	...
	PlaceOrder(ctx context.Context, key *ecdsa.PrivateKey, order *pb.Order) OrderOrError
...
func (api *BasicMarketAPI) OpenDeal(ctx context.Context, key *ecdsa.PrivateKey, askID, bidID *big.Int) DealOrError {
	opts := getTxOpts(ctx, key, defaultGasLimitForSidechain, api.opts.gasPrice)
	tx, err := api.marketContract.OpenDeal(opts, askID, bidID)
	if err != nil {
		return DealOrError{nil, err}
	}
...
func (api *BasicMarketAPI) CloseDeal(ctx context.Context, key *ecdsa.PrivateKey, dealID *big.Int, blacklisted bool) error {
	...
	if _, err = FindLogByTopic(rec, DealUpdatedTopic); err != nil {
		return err
	}
...
func (api *BasicMarketAPI) PlaceOrder(ctx context.Context, key *ecdsa.PrivateKey, order *pb.Order) OrderOrError {
	opts := getTxOpts(ctx, key, defaultGasLimitForSidechain, api.opts.gasPrice)
	...
	return OrderOrError{orderInfo, err}
}
...
func (api *BasicMarketAPI) CancelOrder(ctx context.Context, key *ecdsa.PrivateKey, id *big.Int) error {
	...
	if _, err := FindLogByTopic(rec, OrderUpdatedTopic); err != nil {
		return err
	}
	return nil
}
...
func (api *BasicMarketAPI) Bill(ctx context.Context, key *ecdsa.PrivateKey, dealID *big.Int) error {
	...
	if _, err := FindLogByTopic(rec, BilledTopic); err != nil {
		return err
	}
	return nil
}
...
func (api *BasicMarketAPI) RegisterWorker(ctx context.Context, key *ecdsa.PrivateKey, master common.Address) error {
	...
	if _, err := FindLogByTopic(rec, WorkerAnnouncedTopic); err != nil {
		return err
	}
	return nil
}
...
func (api *BasicMarketAPI) ConfirmWorker(ctx context.Context, key *ecdsa.PrivateKey, slave common.Address) error {
	...
	if _, err := FindLogByTopic(rec, WorkerConfirmedTopic); err != nil {
		return err
	}
	return nil
}
...
func (api *BasicMarketAPI) RemoveWorker(ctx context.Context, key *ecdsa.PrivateKey, master, slave common.Address) error {
	...
	if _, err := FindLogByTopic(rec, WorkerRemovedTopic); err != nil {
		return err
	}
	return nil
}
...
func (api *BasicMarketAPI) CreateChangeRequest(ctx context.Context, key *ecdsa.PrivateKey, req *pb.DealChangeRequest) (*big.Int, error) {
	...
	logs, err := FindLogByTopic(rec, DealChangeRequestSentTopic)
	if err != nil {
		return nil, err
	}
